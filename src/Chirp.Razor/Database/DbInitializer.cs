    ...
    public static class DbInitializer
    {
        public static void SeedDatabase(ChatDbContext chirpContext)
        {
            if (!(chirpContext.Authors.Any() && chirpContext.Cheeps.Any()))
            {
                var a1 = new Author()
                {
                    AuthorId = 1, Name = "Roger Histand", Email = "Roger+Histand@hotmail.com",
                ...
                var a3 = new Author()
                {
                    AuthorId = 3, Name = "Wendell Ballan", Email = "Wendell-Ballan@gmail.com",
                    Cheeps = new List<Cheep>()
                };
                var a4 = new Author()
                {
                ...
                var a7 = new Author()
                {
                    AuthorId = 7, Name = "Malcolm Janski", Email = "Malcolm-Janski@gmail.com",
                    Cheeps = new List<Cheep>()
                };
                var a8 = new Author()
                {
                    AuthorId = 8, Name = "Octavio Wagganer", Email = "Octavio.Wagganer@dtu.dk",
                    Cheeps = new List<Cheep>()
                };
                var a9 = new Author()
                {
                ...
                var a11 = new Author()
                    { AuthorId = 11, Name = "Helge", Email = "ropf@itu.dk", Cheeps = new List<Cheep>() };
                var a12 = new Author()
                ...
                var c20 = new Cheep()
                {
                    CheepId = 20, AuthorId = a1.AuthorId, Author = a1,
                    Text = "In the card-case is a wonderful old man!", Timestamp = DateTime.Parse("2023-08-01 13:15:42")
                };
                var c21 = new Cheep()
                {
                ...
                var c30 = new Cheep()
                {
                    CheepId = 30, AuthorId = a10.AuthorId, Author = a10,
                    Text = "That is where the wet and shining eyes.", Timestamp = DateTime.Parse("2023-08-01 13:13:27")
                };
                var c31 = new Cheep()
                {
                ...
                var c142 = new Cheep()
                {
                    CheepId = 142, AuthorId = a10.AuthorId, Author = a10,
                    Text = "Starbuck now is what we hear the worst.", Timestamp = DateTime.Parse("2023-08-01 13:17:39")
                };
                var c143 = new Cheep()
                {
                ...
                var c144 = new Cheep()
                {
                    CheepId = 144, AuthorId = a7.AuthorId, Author = a7,
                    Text = "And all this while, drew nigh the wharf.", Timestamp = DateTime.Parse("2023-08-01 13:13:41")
                };
                var c145 = new Cheep()
                {
                ...
                var c198 = new Cheep()
                {
                    CheepId = 198, AuthorId = a10.AuthorId, Author = a10,
                    Text = "My friend insisted upon her just now.", Timestamp = DateTime.Parse("2023-08-01 13:14:35")
                };
                var c199 = new Cheep()
                {
                ...
                var c217 = new Cheep()
                {
                    CheepId = 217, AuthorId = a10.AuthorId, Author = a10,
                    Text = "What is it, too, that under the door.", Timestamp = DateTime.Parse("2023-08-01 13:15:10")
                };
                var c218 = new Cheep()
                {
                ...
                var c223 = new Cheep()
                {
                    CheepId = 223, AuthorId = a10.AuthorId, Author = a10,
                    Text = "What do you make him let go his hold.", Timestamp = DateTime.Parse("2023-08-01 13:13:23")
                };
                var c224 = new Cheep()
                {
                ...
                var c260 = new Cheep()
                {
                    CheepId = 260, AuthorId = a10.AuthorId, Author = a10,
                    Text = "Why not here, as well known in surgery.", Timestamp = DateTime.Parse("2023-08-01 13:13:17")
                };
                var c261 = new Cheep()
                {
                ...
                var c289 = new Cheep()
                {
                    CheepId = 289, AuthorId = a10.AuthorId, Author = a10,
                    Text = "We were engaged in reading pamphlets.", Timestamp = DateTime.Parse("2023-08-01 13:14:38")
                };
                var c290 = new Cheep()
                {
                ...
                var c334 = new Cheep()
                {
                    CheepId = 334, AuthorId = a10.AuthorId, Author = a10,
                    Text = "Together we made our way to the ground.", Timestamp = DateTime.Parse("2023-08-01 13:13:29")
                };
                var c335 = new Cheep()
                {
                ...
                var c360 = new Cheep()
                {
                    CheepId = 360, AuthorId = a8.AuthorId, Author = a8,
                    Text = "And another thousand to him as possible.", Timestamp = DateTime.Parse("2023-08-01 13:15:34")
                };
                var c361 = new Cheep()
                {
                ...
                var c374 = new Cheep()
                {
                    CheepId = 374, AuthorId = a1.AuthorId, Author = a1,
                ...
                var c419 = new Cheep()
                {
                    CheepId = 419, AuthorId = a10.AuthorId, Author = a10,
                    Text = "What a relief it was the place examined.", Timestamp = DateTime.Parse("2023-08-01 13:16:30")
                };
                var c420 = new Cheep()
                {
                ...
                var c432 = new Cheep()
                {
                    CheepId = 432, AuthorId = a10.AuthorId, Author = a10,
                    Text = "No man burdens his mind in the morning.", Timestamp = DateTime.Parse("2023-08-01 13:13:53")
                };
                var c433 = new Cheep()
                {
                ...
                var c436 = new Cheep()
                {
                    CheepId = 436, AuthorId = a1.AuthorId, Author = a1,
                ...
                var c448 = new Cheep()
                {
                    CheepId = 448, AuthorId = a1.AuthorId, Author = a1,
                    Text = "He saw her white face and flashing eyes.", Timestamp = DateTime.Parse("2023-08-01 13:13:18")
                };
                var c449 = new Cheep()
                {
                ...
                var c475 = new Cheep()
                {
                    CheepId = 475, AuthorId = a10.AuthorId, Author = a10,
                    Text = "I watched his son be a castor of state.", Timestamp = DateTime.Parse("2023-08-01 13:13:57")
                };
                var c476 = new Cheep()
                {
                ...
                var c501 = new Cheep()
                {
                    CheepId = 501, AuthorId = a10.AuthorId, Author = a10,
                    Text = "It is asking much of it in the world.", Timestamp = DateTime.Parse("2023-08-01 13:16:50")
                };
                var c502 = new Cheep()
                {
                ...
                var c517 = new Cheep()
                {
                    CheepId = 517, AuthorId = a10.AuthorId, Author = a10,
                    Text = "Those buckskin legs and fair ramping.", Timestamp = DateTime.Parse("2023-08-01 13:14:00")
                };
                var c518 = new Cheep()
                {
                ...
                var c543 = new Cheep()
                {
                    CheepId = 543, AuthorId = a1.AuthorId, Author = a1,
                    Text = "It was the secret seas have ever known.", Timestamp = DateTime.Parse("2023-08-01 13:13:36")
                };
                var c544 = new Cheep()
                {
                ...
                var c580 = new Cheep()
                {
                    CheepId = 580, AuthorId = a5.AuthorId, Author = a5,
                    Text = "For myself, my term of imprisonment was.", Timestamp = DateTime.Parse("2023-08-01 13:13:52")
                };
                var c581 = new Cheep()
                {
                ...
                var c595 = new Cheep()
                {
                    CheepId = 595, AuthorId = a9.AuthorId, Author = a9,
                    Text = "Hunter was seated all in this way, then.", Timestamp = DateTime.Parse("2023-08-01 13:13:48")
                };
                var c596 = new Cheep()
                {
